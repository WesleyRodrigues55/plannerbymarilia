                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php if (session()->has('usuario')): ?>
                                    ...
                                    <!-- <form action="carrinho/adiciona-produto-carrinho" method="post"> -->
                                        <input type="text" name="id-produto" value="<?= $b['ID'] ?>" id="" hidden readonly>
                                        <input type="text" name="slug" value="<?= $b['SLUG'] ?>" id="" hidden readonly>
                                ...
                                <?php else: ?>
                                    <button type="submit" id="submit" name="submit" class="faca-login" id="faca-login-<?= $b['SLUG'] ?>" style="border: none; background: #fff;">
                                        <img src="<?= base_url('assets/img/shopping-cart.png') ?>" alt="" style="width:36px; height: 36px">
                                    </button>
                                <?php endif; ?>
                            </div>
