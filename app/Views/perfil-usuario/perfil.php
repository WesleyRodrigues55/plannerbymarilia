        ...
        <div class="row">
            <div class="col-md-3">
                <div class="vertical-tabs">
                    <a id="content1" class="mb-2" style="box-shadow: 5px 5px 3px rgba(0, 0, 0, 0.2);">Minhas informações</a>
                    <a id="content2" class="mb-2" style="box-shadow: 5px 5px 3px rgba(0, 0, 0, 0.2);">Dados do Usuário</a>
                    <a id="content3" class="mb-2" style="box-shadow: 5px 5px 3px rgba(0, 0, 0, 0.2);">Meus Depoimentos</a>
                    <a id="content4" class="mb-2" style="box-shadow: 5px 5px 3px rgba(0, 0, 0, 0.2);">Minhas compras</a>
                </div>
            </div>
