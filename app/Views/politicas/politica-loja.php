...
<main>
    <div class="container">
        <div class="politica my-5">
            ...
            <div class="mt-5">
                <p>DESISTÊNCIA E DEVOLUÇÃO:</p><br>

                <p>A. Após a finalização e/ou envio do produto.</p>
                ...
                <p>B. Após o início da produção e antes da finalização - para produtos com capa personalizada.</p>
                ...
                <p>C. Após o início da produção e antes da finalização - para produtos 100% personalizados.</p>
                ...
                <p>NOTA: Mal uso do produto não pode ser motivo de reclamação para troca. Lembrando que produtos de
                    papelaria são naturalmente delicados. É preciso ter cuidado com mal acondicionamento, umidade,
                    atritos, quedas e batidas.</p><br>


                <p>PRAZO DE PRODUÇÃO:</p><br>
                ...
                <p>4. Em caso de eventual extrapolação do prazo de produção do pedido, o cliente poderá entrar em
                    contato através do e-mail, planner.bymarilia@hotmail.com, informando o número do pedido realizado.</p>
            </div>
      </div>
    </div>
</main>
