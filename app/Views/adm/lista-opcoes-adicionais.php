...
<div class="container">
    ...
    <nav class="navbar mt-10 bg-white">
        <div class="container-fluid">
            <form class="d-flex gap-2" role="search" method="get" action="<?= base_url('administrador/lista-opcoes-adicionais') ?>">
                <input class="form-control" type="search" name="search" placeholder="Pesquise o adicional" aria-label="Search">
                ...
                <td colspan="4">
                    ...
                    <?php if ($message_empty) : ?>
                        <div class="alert alert-danger mt-5 text-center" role="alert">
                            <?= $message_empty; ?>  
                            <br><br><a href="<?= base_url('/administrador/cadastro-opcoes-adicionais') ?>" class="input-rosa m-2">Clique aqui</a> para cadastrar uma opção adicional
                        </div>
                    <?php else : ?>
