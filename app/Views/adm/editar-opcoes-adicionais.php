<?php
$data['title'] = "Editar Opções Adicionais";
...
<div class="container">
    <div class="cadastro my-5">
        ...
        <?php $message_success = session()->getFlashdata('att-adcional-success'); ?>
        <?php $message_failed = session()->getFlashdata('att-adicional-failed'); ?>
