        ...
        <form class="teste" method="post">
            <div class="row">
                <div class="col-md-12 mt-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="categoria" placeholder="Categorias" required>
                </div>
                <!-- ../row -->
            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="<?= base_url('administrador/editar-categoria') ?>" class="btn btn input-rosa">VOLTAR</a>
                            </div>
                        </div>
                    </div>
                </div>
