    ...
    <main class="container my-5">
        ...
        <?php if ($message_success): ?>
            <div class="alert alert-success mt-5 text-center" role="alert">
                <?= $message_success; ?>
                <br><a href="<?= base_url('/comprando/escolhendo-endereco-de-entrega/'. session()->get('id_carrinho')) .'/'. $id_usuario ?>" >Clique aqui</a> para continuar o processo de compra
        ...
        <form method="post" action="/comprando/cadastrar-endereco-de-entrega">
            ...
            <div class="row">
                ...
                <div class="col-md-6 my-2">
                    ...
                    <input maxlength="11" type="text" id="telefone" name="celular" class="form-control" tabindex="2" required>
                </div>
                <div class="col-md-6 my-2">
                    <label for="">CEP *</label>
