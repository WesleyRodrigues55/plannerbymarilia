            ...
            <form class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="email" class="form-control w-100" id="email" placeholder="">
                ...
                <div class="row">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="termos">Ao usar este formulário de cadastro, você concorda com
                            o
