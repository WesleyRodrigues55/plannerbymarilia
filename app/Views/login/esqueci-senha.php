...
<div class="h-100 d-flex  justify-content-center align-items-center">
    <div class="text-center" style="width:420px;">
        <img src="assets/img/logo-projeto.png" alt="logo-projeto" class="logo text-center">
            ...
            <form method="post" action="" class="formulario">
                <div class="mb-3 d-flex align-items-center">
                    <div style="position: relative; width: 100%;">
                        <input class="mb-10 w-379px form-control" id="esqueci-senha" type="email" placeholder="Digite seu email" required maxlength="64" name="EMAIL" />
                        <img src="assets/icons/user-pink.png" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%); height: 20px; width: 20px;" alt="Ícone User" />
                    </div>
                </div>
