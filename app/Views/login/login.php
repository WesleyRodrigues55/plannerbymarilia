        ...
        <form method="post" action="" class="formulario">
            <div class="mb-3 d-flex align-items-center">
                <div style="position: relative; width: 100%;">
                    ...
                    <img src="assets/img/user-pink.png" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%); height: 20px; width: 20px;" alt="Ícone user" />
                </div>
            </div>
            ...
            <div class="mb-3 d-flex align-items-center">
                <div style="position: relative; width: 100%;">
                    ...
                    <img src="assets/img/password-pink.png" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%); height: 20px; width: 20px;" alt="Ícone Senha" />
                </div>
            </div>
